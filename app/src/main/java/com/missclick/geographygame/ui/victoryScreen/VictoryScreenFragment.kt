...
import com.missclick.geographygame.databinding.FragmentVictoryScreenBinding
...
class VictoryScreenFragment : Fragment() {
    ...
    private val bind by viewBinding(FragmentVictoryScreenBinding::bind)
    val screenViewModel : VictoryScreenViewModel by viewModel()
